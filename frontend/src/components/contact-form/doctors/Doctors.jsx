...
const Doctors = () => {
    ...
    return (
        <> <section className = 'doctors-section' > <div className="doctors-title">
            <Typography variant="h4" align="center"className="text-white  mt-0.5" > Nuestros Profesionales</Typography>
              ...
              return(
                  <div className="doctors-container">
                      ...
                      <div className="doctors-text" key={index}>
                          <Typography variant="h6">Dr.{doctor.lastname}</Typography>
                      ...
                      <div className="doctors-img">
                          <img src={doctors.photoUrl} alt="doctor"/>
                      </div>
